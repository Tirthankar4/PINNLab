"""
models/wave.py
WavePINN: PINN for 1D wave equation with parameter embedding for wave speed.
"""
...
class WavePINN(Base_P2PINN):
    def __init__(self, num_neurons=96, use_param_embedding=True,
                 ...
                 main_pinn_layers=5):
        # input: (x, t, c), output: u
        # Always use parameter embedding for wave speed (c) like alpha in hydrodynamics
...
class WaveSimplePINN(Base_SimplePINN):
